...
(define-class notification-page% html-page% ()
  ...
  (define/augment (render seed)
    (xml (h1 "Notification page " ,page-number)
         (p (a (@ [href ,(controller-url notification-page1)]) "Visit page 1") " "
            (a (@ [href ,(controller-url notification-page2)]) "Visit page 2"))
...
(define-page notification-page1
  (new notification-page% [page-number 1]))

(define-page notification-page2
