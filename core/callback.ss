...
; *** NOTE:
; *** Do not require this file directly outside of the core directory.
; *** Require embed.ss instead: it reprovides this module and rebinds "callback".
...
; callback [(alistof symbol string)] -> url
