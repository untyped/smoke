...
(require scheme/contract
         srfi/13
         (prefix-in sql: (planet untyped/snooze:2/sql/sql-struct))
  ...
  (class/cells object/cells% ()
    ...
    (define/public (render-head seed sort-dir)
      (let* ([id        (get-id)]                      ; symbol
        ...
        (xml (th (@ [class ,(case sort-dir
                              [(asc)  (format-classes (list* 'sort 'asc classes))]
                              [(desc) (format-classes (list* 'sort 'desc classes))]
                              [(#f)   (format-classes (list* 'sort classes))])])
                 ,(if sortable?
